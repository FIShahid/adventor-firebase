...
const Blogs = () => {
    return (
        <div className='container'>
            <h1 className='text-primary text-center mt-3 mb-3'>Question and Answer</h1>

            <div>
                <h4 className='mb-3 text'> Difference between Authorization and Authentication</h4>
            ...
            <div>
            <h4 className='mb-3 text'> Why are you using firebase? What other options do you have to implement authentication?</h4>
                <p>
